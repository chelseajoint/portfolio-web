    ...
    <section className="about" id="about">
      ...
      <div className={`mobile-dropdown ${isOpen ? "open" : ""}`}>
        <h4>
          ...
          experiencia en diseño gráfico. Mi trayectoria académica comenzó con
          una licenciatura en Diseño de Publicidad en la Universidad Estatal de
          Tecnología y Diseño de San Petersburgo, donde obtuve mi título en
          2015. Posteriormente, continué mi formación con un Máster en Diseño
          Editorial: Medios Impresos y Digitales en el IED Madrid, del cual me
          gradué en 2017.
          <br />
          <br />
          Empecé mi carrera como diseñadora gráfica pero durante mi trabajo en{" "}
          <span className="accent">Wunderman Thomson</span> y{" "}
          <span className="accent">Craft</span> trabajé diseñando y programando
          las piezas creativas y fue ahí donde descubrí mi pasión por la
          programación. Durante los últimos años he estado enfocando mi carrera
          en desarrollo web, aprendiendo lenguajes de programación como{" "}
          ...
          <br />
          <br />
          Si tienes alguna pregunta o simplemente quieres charlar, no dudes en
          ponerte en contacto conmigo. Estoy aquí para ayudar en lo que
          necesites.
          <br />
          <br />
          ¡Gracias por tu interés y espero tener la oportunidad de colaborar
          juntos!
        </h4>
      </div>
    </section>
